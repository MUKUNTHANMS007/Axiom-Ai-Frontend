                ...
                <div className="flex items-start gap-4 sm:gap-6">
                  ...
                  >
                    <Card 
                      ...
                      item.onClick && "cursor-pointer hover:-translate-y-1 hover:border-primary/50"
                    )}>
                      <CardContent className="p-4 sm:p-6">
                        ...
                        {item.tech_slugs && item.tech_slugs.length > 0 && (
                          <div className="flex flex-wrap gap-2 mb-6">
                            {item.tech_slugs.map((slug, i) => (
                              <TechIcon key={i} slug={slug} size={18} className="w-7 h-7" />
                            ))}
                          </div>
                        )}
