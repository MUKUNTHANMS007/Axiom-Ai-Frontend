      ...
      >
        ...
        <div
          className={cn(
            ...
            (isRecording || isTranscribing) ? "h-0 overflow-hidden opacity-0" : "opacity-100"
          )}
        >
          <PromptInputTextarea
            placeholder={
        ...
        {isTranscribing && (
           <div className="flex flex-col items-center justify-center py-6 gap-3 animate-in fade-in duration-500">
             <Loader2 className="h-8 w-8 text-primary animate-spin" />
             <p className="text-sm font-label text-on-surface-variant animate-pulse">Transcribing your vision...</p>
           </div>
        )}
